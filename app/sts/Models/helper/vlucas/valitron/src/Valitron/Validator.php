<?php
namespace App\sts\Models\helper\vlucas\valitron\src\Valitron;
    ...
    public function validate($data)
    {
        ...
        foreach ($this->_validations as $v) {
            foreach ($v['fields'] as $field) {
                ...
                list($values, $multiple) = $this->getPart($data, explode('.', $field), false);
                ...
                foreach ($values as $value) {
                    $result = $result && call_user_func($callback, $field, $value, $v['params'], $data);
                }
