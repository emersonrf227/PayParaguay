<footer class="footer">
    <div class="container-fluid">
        <div class="copyright float-right" id="date">
            2023, Desenvolvido por <a href="https://www.iliketechnology.com.br" target="_blank" style="color:#ff9800">I
                Like Technology</a>.
        </div>
    </div>
</footer>
...
<!--   Core JS Files   -->
<script src="<?php echo URL; ?>assets/js/core/jquery.min.js"></script>
<script src="<?php echo URL; ?>assets/js/core/popper.min.js"></script>
<script src="<?php echo URL; ?>assets/js/core/bootstrap-material-design.min.js"></script>
...
<script src="<?php echo URL; ?>assets/js/material-dashboard.js?v=2.1.0"></script>
...
$(document).ready(function() {
    const access_token = window.location.getItem("access_token");
