            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card card-stats">
                    <div class="card-header card-header-warning card-header-icon">
                        ...
                        <p class="card-category">Saldo Total em Polygon (MATIC) <img src="../assets/img/matic-logo.png"
                                width="25px"></p>

                        <h3 class="card-title" id="balancePlg">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            ...
                            <b><a class="warning-link">Atenção ao seu saldo em Polygon. O saldo baixo ou zerado poderá
                                    acarretar em problemas em sua operação.</a></b>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-warning card-header-icon">
                        ...
                        <h3 class="card-title" id="qtyUsers">...</h3>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
                            <i class="material-icons">feedback</i> Total Geral
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-success card-header-icon">
                        ...
                        <p class="card-category">Total em Transações Recebidas (R$)</p>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-warning">
                        <h4 class="card-title">Últimas transações recebidas</h4>
                        <p class="card-category">Início das transações em 09 de Outubro de 2023.</p>
                    </div>
...
async function load() {
    ...
    try {
        ...
        if (response.data.error === 0) {
            ...
            const balancePlg = Number(response.data.res.hot_balance).toFixed(6);
